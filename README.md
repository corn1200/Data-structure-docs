...
## 이진 트리 순회 방법
* 중위 순회(): 왼쪽 자손, 자신, 오른쪽 자손 순서로 방문하는 순회 방법.  
이진 탐색 트리를 중위 순회하면 정렬된 결과를 얻을 수 있다.
* 전위 순회(): 자신, 왼쪽 자손, 오른쪽 자손 순서로 방문하는 순회 방법.
* 후위 순회(): 왼쪽 자손, 오른쪽 자손, 자신 순서로 방문하는 순회 방법.
* 레벨 순서 순회(): 너비 우선 순회(Breadth-First traversal)라고도 한다.   
